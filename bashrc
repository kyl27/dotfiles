...
xcd () {
    \cd "$1" && echo "`pwd`" > ~/.lastcd
}
alias cd=xcd

## because git verification won't work through the dev proxy
...
LS_COLORS='di=01;94:fi=1;94:ln=31:pi=5:so=5:bd=5:cd=5:or=31:mi=0:ex=1;93:*.rpm=90:*.tar=1;31'
export LS_COLORS
...
# PS1='\[\033]0;\w\007\]\[\e[1;35m\]\u\[\e[1;32m\]@\h\[\e[1;94m\]\w\[\e[1;93m\]\$ \[\e[0;97m\]'	# purple, green, blue prompt w/default black & dir title
...
PS1='\[\033[01;35m\]\u\[\033[01;36m\]@\[\033[01;32m\]\h:\[\033[01;36m\]\w\[\033[01;33m\]\$ \[\033[00;97m\]'	# red, cyan, green, yellow with green output
